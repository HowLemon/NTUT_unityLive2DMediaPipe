...
public class HolisticAnnotationController : AnnotationController {
  ...
  void Awake() {
    ...
    leftIrisLandmarksAnnotation.name = "leftIrisLandmarksAnnotation";
    rightIrisLandmarksAnnotation = Instantiate(irisLandmarksPrefab);
    rightIrisLandmarksAnnotation.name = "rightIrisLandmarksAnnotation";
    leftHandLandmarksAnnotation = Instantiate(handLandmarksPrefab);
    leftHandLandmarksAnnotation.name = "leftHandLandmarksAnnotation";
    rightHandLandmarksAnnotation = Instantiate(handLandmarksPrefab);
    rightHandLandmarksAnnotation.name = "rightHandLandmarksAnnotation";
  }
