...
public class FaceMeshEyeLeft : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (faceNodes != null)
        {
            eyeCloseDistance = Vector3.Distance(faceNodes[159].transform.position, faceNodes[145].transform.position) / Vector3.Distance(faceNodes[4].transform.position, faceNodes[5].transform.position);
            //Debug.Log(eyeCloseDistance);
        }
    }
