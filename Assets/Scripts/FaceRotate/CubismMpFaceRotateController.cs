...
{
    public sealed class CubismMpFaceRotateController : MonoBehaviour, ICubismUpdatable
    {
        [SerializeField]
        ...
        {
            get { return _target; }
            set { _target = value.ToNullUnlessImplementsInterface<ICubismMpFaceRotateTarget>(); }
        }


        private ICubismMpFaceRotateTarget _targetInterface;

        private ICubismMpFaceRotateTarget TargetInterface
        {
            get
            {
                if (_targetInterface == null)
                {
                    _targetInterface = Target.GetInterface<ICubismMpFaceRotateTarget>();
                }
        ...
        private CubismMpFaceRotateParameter[] Sources { get; set; }
        ...
        public void Refresh()
        {
            ...
            Sources = model
                .Parameters
                .GetComponentsMany<CubismMpFaceRotateParameter>();
        ...
        {
            get { return CubismUpdateExecutionOrder.CubismMpFaceRotateController; }
        }
